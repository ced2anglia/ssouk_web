...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.selected'
        db.add_column('inventory_item', 'selected', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.selected'
        db.delete_column('inventory_item', 'selected')
    ...
    models = {
        ...
        'inventory.item': {
            ...
            'expire_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 4, 22, 31, 43, 284809)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
